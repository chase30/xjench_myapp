 ...
 *
 */
public class DedeArchivesEntityList implements java.io.Serializable {
	
	ArrayList<DedeArchivesEntity> dedeArchivelist;
	private int pageTotal;
	public ArrayList<DedeArchivesEntity> getDedeArchivelist() {
		return dedeArchivelist;
	}

	public void setDedeArchivelist(ArrayList<DedeArchivesEntity> dedeArchivelist) {
	...
	public ArrayList<DedeArchivesEntity> getData() {
		return dedeArchivelist;
	}
